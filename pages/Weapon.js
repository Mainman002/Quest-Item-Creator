...
addEventListener('load', (e) => {
    ...
    function set_values() {
        ...
        if ( item_values['spell_name'] ) {
            combined_values = `["${item_values['item_name']}",["${item_values['flag_type']}","${item_values['flag_common']}"],"${item_values['skill']}",(${item_values['slot_right']},${item_values['slot_left']}),${item_values['destructable']},"${main.images[bitmap_type.selectedIndex][main.active_image][2]}","${main.images[bitmap_type.selectedIndex][main.active_image][1]}","${item_values['material']}",${item_values['speed']},${item_values['damage']},${item_values['range']},${item_values['armor']},${item_values['copper']},${item_values['silver']},${item_values['tin']},${item_values['gold']},"${item_values['desc']}","${item_values['equiped_particle']}","${item_values['race']}",("${item_values['spell_name']}",${item_values['spell_trigger']},${item_values['spell_damage']}), [${item_values['add_stats']}] ],`;
        } else {
